...
class StateMachineTransition(object):
    ...
    def __init__(self, source_state, transition_function):
...
class StateMachineState(object):
    ...
    def execute(self, state_sequence_instance):
        ...
        """
        print("Executing assertion function '%s'..." % self._assertion_function.__name__)
...
class StateSequence(object):
    ...
    def __repr__(self):
        return "<StateSequence %s>" % self._sequence
    ...
    def execute(self):
        ...
        """
        print("-- Executing test sequence #%i --\n" % self._label)
